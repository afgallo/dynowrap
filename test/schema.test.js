...
describe('schema', () => {
  describe('setup', () => {
    ...
    it('should setup local secondary index when both hash and range keys are given', () => {
      const config = {
        hashKey: 'foo',
        indexes: [{ hashKey: 'foo', rangeKey: 'bar', type: 'local', name: 'LocalBarIndex' }]
      }
    ...
    it('should setup local secondary index when only range key is given', () => {
      const config = {
        hashKey: 'foo',
        indexes: [{ rangeKey: 'bar', type: 'local', name: 'LocalBarIndex' }]
      }
    ...
    it('should throw when local index rangeKey isnt present', () => {
      const config = {
        hashKey: 'foo',
        indexes: [{ hashKey: 'foo', type: 'local', name: 'LocalBarIndex' }]
      }
    ...
    it('should throw when local index hashKey does not match the tables hashKey', () => {
      const config = {
        hashKey: 'foo',
        indexes: [{ hashKey: 'bar', rangeKey: 'date', type: 'local', name: 'LocalDateIndex' }]
      }
    ...
    it('should setup global index', () => {
      const config = {
        hashKey: 'foo',
        indexes: [{ hashKey: 'bar', type: 'global', name: 'GlobalBarIndex' }]
      }
    ...
    it('should throw when global index hashKey is not present', () => {
      const config = {
        hashKey: 'foo',
        indexes: [{ rangeKey: 'date', type: 'global', name: 'GlobalDateIndex' }]
      }
