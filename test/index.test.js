...
describe('dynowrap', () => {
  ...
  describe('#define', () => {
    it('should return model', () => {
      ...
      const model = dynowrap.define('Account', config)
      expect(model).to.be.a('function')
    })

    it('should throw when using old api', () => {
      expect(() => {
        dynowrap.define('Account', (schema) => {
    ...
    it('should have config method', () => {
      const Account = dynowrap.define('Account', { hashKey: 'id' })
  ...
  describe('#models', () => {
    it('should be empty', () => {
      dynowrap.models.should.be.empty
    })

    it('should contain single model', () => {
      dynowrap.define('Account', { hashKey: 'id' })

      dynowrap.models.should.contain.keys('Account')
    })
  })
  ...
  describe('#model', () => {
    it('should return defined model', () => {
      ...
      dynowrap.model('Account').should.equal(Account)
    })

    it('should return null', () => {
      expect(dynowrap.model('Person')).to.be.null
    })
  })
  ...
  describe('model config', () => {
    ...
    it('should globally set dynamodb driver for all models', () => {
      const Account = dynowrap.define('Account', { hashKey: 'id' })
      const Post = dynowrap.define('Post', { hashKey: 'id' })
  ...
  describe('#createTables', () => {
    ...
    beforeEach(() => {
      ...
      // dynowrap.dynamoDriver(dynamodb);
      dynowrap.documentClient(helper.mockDocClient())
    ...
    it('should create single definied model', function (done) {
      ...
      dynamodb.describeTable.onCall(0).yields(null, null).onCall(1).yields(null, second).onCall(2).yields(null, third)
