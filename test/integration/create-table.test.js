...
describe('Create Tables Integration Tests', function () {
  ...
  before(() => {
    dynowrap.dynamoDriver(helper.realDynamoDB())
  })
  ...
  it('should create table with hash key', (done) => {
    const Model = dynowrap.define('dynowrap-create-table-test', {
      hashKey: 'id',
      tableName: helper.randomName('dynowrap-createtable-Accounts'),
      schema: {
        id: Joi.string()
      }
    })
    ...
    Model.createTable((err, result) => {
      ...
      expect(desc.AttributeDefinitions).to.eql([{ AttributeName: 'id', AttributeType: 'S' }])
  ...
  it('should create table with hash and range key', (done) => {
    const Model = dynowrap.define('dynowrap-createtable-rangekey', {
      hashKey: 'name',
      rangeKey: 'age',
      tableName: helper.randomName('dynowrap-createtable-rangekey'),
      schema: {
        name: Joi.string(),
        age: Joi.number()
      }
  ...
  it('should create table with local secondary index', (done) => {
    const Model = dynowrap.define('dynowrap-createtable-rangekey', {
      hashKey: 'name',
      rangeKey: 'age',
      tableName: helper.randomName('dynowrap-createtable-local-idx'),
      schema: {
        name: Joi.string(),
        age: Joi.number(),
        nick: Joi.string(),
  ...
  it('should create table with local secondary index with custom projection', (done) => {
    const Model = dynowrap.define('dynowrap-createtable-local-proj', {
      hashKey: 'name',
      rangeKey: 'age',
      tableName: helper.randomName('dynowrap-createtable-local-proj'),
      schema: {
        name: Joi.string(),
        age: Joi.number(),
        nick: Joi.string()
  ...
  it('should create table with global index', (done) => {
    const Model = dynowrap.define('dynowrap-createtable-global', {
      hashKey: 'name',
      rangeKey: 'age',
      tableName: helper.randomName('dynowrap-createtable-global'),
      schema: {
        name: Joi.string(),
        age: Joi.number(),
        nick: Joi.string()
    ...
    Model.createTable((err, result) => {
      ...
      expect(nickIndex.Projection).to.eql({ ProjectionType: 'ALL' })
      expect(nickIndex.KeySchema).to.eql([{ AttributeName: 'nick', KeyType: 'HASH' }])
  ...
  it('should create table with global and local indexes', (done) => {
    const Model = dynowrap.define('dynowrap-createtable-both-indexes', {
      hashKey: 'name',
      rangeKey: 'age',
      tableName: helper.randomName('dynowrap-createtable-both-indexes'),
      schema: {
        name: Joi.string(),
        age: Joi.number(),
        nick: Joi.string(),
...
describe('Update Tables Integration Tests', function () {
  ...
  before((done) => {
    ...
    tableName = helper.randomName('dynowrap-updateTable-Tweets')

    Tweet = dynowrap.define('dynowrap-update-table-test', {
      hashKey: 'UserId',
      rangeKey: 'TweetID',
      tableName,
      schema: {
  ...
  it('should add global secondary index', (done) => {
    Tweet = dynowrap.define('dynowrap-update-table-test', {
      ...
      indexes: [{ hashKey: 'UserId', rangeKey: 'PublishedDateTime', type: 'global', name: 'PublishedDateTimeIndex' }]
    })
