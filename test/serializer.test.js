...
describe('Serializer', () => {
  ...
  describe('#serializeItem', () => {
    ...
    it('should serialize uuid attribute', () => {
      ...
      const item = serializer.serializeItem(s, { id })
    ...
    it('should serialize TimeUUId attribute', () => {
      ...
      const item = serializer.serializeItem(s, { timeid })

      item.should.eql({ timeid })
    })
  ...
  describe('#serializeItemForUpdate', () => {
    ...
    it('should not serialize hashkey and rangeKey attributes', () => {
      ...
      const item = serializer.serializeItemForUpdate(s, 'PUT', {
        email: 'test@test.com',
        range: 'FOO',
        name: 'Tim Tester'
      })
